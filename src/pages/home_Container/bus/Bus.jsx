...
import Bus1 from "../../../assets/bus.png"; // Assuming you're using this image later
import Bus2 from "../../../assets/bus4.png";
import Bus3 from "../../../assets/bus5.png";
import Bus4 from "../../../assets/bus6.png";
import Bus5 from "../../../assets/bus7.png";
import Bus6 from "../../../assets/bus8.png";
  ...
  return (
    <div className="w-full lg:px-28 md:px-16 sm:px-7 px-4 mt-[13ch] mb-[8ch] space-y-10 ">
      <div className="w-full grid grid-cols-6 gap-14 bg-neutral-200/60 dark:bg-neutral-900/40 rounded-md px-6 py-5 items-center justify-between">
        ...
        <select className="w-full.apperence-none text-neutral-800 dark:text-neutral-100 placeholder:text-neutral-400  dark:placeholder:text-neutral-600 inline-block bg-neutral 200/60 dark:bg-neutral-900/60 px-3 h-12 border border-neutral-200 dark:border-neutral-900 rounded-md focus:outline-none focus:bg-neutral-100 dark:focus:bg-neutral-900">
                                <option value="">Select Bus Type</option>
                                <option value="">Govt Bus</option>
                ...
                <Link to={"/bus/bus-details"} className="w-full bg-neutral-200/60 block dark:bg-neutral-900/40 rounded-xl p-4">
                        ...
                        <div className="px-3 py-4 space-y-2">
                            <div className="flex items-center justify-between">
                                ...
                                <p className="text-sm font-normal text-neutral-800 dark:text-neutral-50">60 Passengers</p>
                            </div>
                        </div>
                </Link>
                <Link to={"/bus/bus-details"} className="w-full bg-neutral-200/60 block dark:bg-neutral-900/40 rounded-xl p-4">
