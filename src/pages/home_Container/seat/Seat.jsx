        ...
        <div className="space-y-5">
            ...
            <div className="w-full flex justify-between">
                ...
                <div className="space-y-3 w-28">
                    <div className=" d-flex items-center row align-items-center mt-7">
                        <MdOutlineChair className="text-lg text-neutral-500 -rotate-90 col-md-6" />
                        <p className="text-neutral-900 dark:text-neutral-200 text-sm font-normal col-md-6 ">
                            Available
                        </p>
                        <MdOutlineChair className="text-lg text-violet-500 -rotate-90 col-md-6 mt-3" />
                        <p className="text-neutral-900 dark:text-neutral-200 text-sm font-normal col-md-6 mt-3">
                            Booked
                        </p>
                        <MdOutlineChair className="text-lg text-violet-500 -rotate-90 col-md-6 mt-3" />
                        <p className="text-neutral-900 dark:text-neutral-200 text-sm font-normal col-md-6 mt-3">
                        ...
                        <RiMoneyRupeeCircleLine className="text-lg text-violet-500 col-md-6 mt-3" />
                        <p className="text-neutral-900 dark:text-neutral-200 text-sm font-normal col-md-6 mt-3">
                            Rs.750
                        </p>
                    </div>
